...
public class DBAdapter {
    ...
    private static final String DATABASE_NAME = "MosPizzaDB";
    ...
    public long inserOrder(String c_name, String c_address, String c_phone, String toppings,
        ...
        initial_values.put(KEY_NAME, c_name);
        initial_values.put(KEY_ADDRESS, c_address);
        initial_values.put(KEY_PHONE, c_phone);
        initial_values.put(KEY_TOPPINGS, toppings);
        initial_values.put(KEY_SIZE, size);

        return db.insert(DATABASE_TABLE, null, initial_values);
    };
    ...
    /** retrieve all the pizzas ordered */
    public Cursor getAllOrders() {
        return db.query(DATABASE_TABLE, new String[] {KEY_ROWID,KEY_NAME,KEY_ADDRESS,
                        KEY_PHONE,KEY_TOPPINGS,KEY_SIZE},null,null,null,null,null);
    };
    ...
    public boolean updateContact(long order_id, String c_name, String c_address, String c_phone, String toppings,
                                 String size) {
